    ...
    <div class="modal-dialog">
        <div class="modal-content radius-style">
            ...
            <div class="modal-body">
                @if (auth()->user())
                <form action="{{ route('restaurantreview') }}" method="POST">
                    @csrf
                    @php
                    $userid = auth()->id();
                    @endphp
                    ...
                    <input type="number" name="restaurantid" hidden readonly value="{{ $restaurant['id'] }}">
                    ...
                    <input type="number" hidden id="ratingInput" name="ratingInput" min="1" max="5">
                    <div class="mt-3">
